...
namespace MiraiPalette.Shared.Exporters
{
    ...
    {
        public static void ExportACO(string filePath, List<MiraiColor> colors, ACOFormatVersion version)
        {
        ...
        public static void ExportACO(BinaryWriter writer, List<MiraiColor> colors, ACOFormatVersion version)
        {
        ...
        private static void WriteVersion1(BinaryWriter writer, List<MiraiColor> colors)
        {
        ...
        private static void WriteVersion2(BinaryWriter writer, List<MiraiColor> colors)
        {
